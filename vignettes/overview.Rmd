...
- If called from the context of a package project or if an option file `/options/options_rapp.r` exists, then these options are read (`readRappOptionFile()`) and merged into the option container `getOption(".rapp")`. 
